...
CREATE TABLE ownerinformation(
	...
	weight INT,
	ssn INT,
	FOREIGN KEY(plate_number) REFERENCES plateinformation(plate_number) ON DELETE SET NULL
);
...
ALTER TABLE plateinformation ADD FOREIGN KEY(plate_number) REFERENCES ownerinformation(plate_number) ON DELETE SET NULL;
